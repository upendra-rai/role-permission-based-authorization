package com.upendra.rai.config;
...
import static com.upendra.rai.entities.Role.ADMIN;
import static com.upendra.rai.entities.Role.MANAGER;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(AbstractHttpConfigurer::disable)
				.authorizeHttpRequests(req -> req.requestMatchers(WHITE_LIST_URL).permitAll()
						...
						.hasAnyAuthority(ADMIN_DELETE.name(), MANAGER_DELETE.name()).anyRequest().authenticated())
